...
<div class="sub-banner">
    ...
    <img class="banner-img" src="{{ asset("assets/images/acido/banner_acido.jpg") }}" alt="">
    <div class="detail">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-title">
                        <h2><span>COMPUESTO</span> QUIMICO</h2>
                        <p> Es un polisacárido del tipo de glucosaminoglucanos compuesto por repetitivos
                            disacáridos poliméricos de ácido D-glucurónico y N-acetil-D-glucosamina unidos por
                            enlaces β. En biología, se distribuye ampliamente en células tanto procariotas como
                            eucariotas.</p>
                    </div>
                </div>
            </div>
