   ...
   <div class="tp-banner-container">
		<div class="tp-banner" >
            ...
            <li data-transition="fade" data-slotamount="7" data-masterspeed="500"  data-saveperformance="on"  data-title="Intro Slide">
                ...
                <img src="{{ asset("assets/images/slides/banner-img8.jpg") }}" alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                ...
                <div class="tp-caption title-bold tp-resizeme rs-parallaxlevel-0 fade start"
                    ...
                    data-endelementdelay="0.1"
                    data-endspeed="300"
                    style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">Microblading
                </div>
                ...
                <div class="tp-caption small-title tp-resizeme rs-parallaxlevel-0 fade start"
                    ...
                    data-endelementdelay="0.1"
                    data-endspeed="300"
                    style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">Rostro Rejuvenecido
                </div>
	...
	<li data-transition="fade" data-slotamount="7" data-masterspeed="500"  data-saveperformance="on"  data-title="Intro Slide">
		...
		<img src="{{ asset("assets/images/slides/banner-img9.jpg") }}"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
		...
		<div class="tp-caption title-bold tp-resizeme rs-parallaxlevel-0 fade start"
			...
			data-endelementdelay="0.1"
			data-endspeed="300"
			style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">Micro Pigmentado
		</div>
		...
		<div class="tp-caption paragraph tp-resizeme rs-parallaxlevel-0 fade start"
			...
			data-endelementdelay="0.1"
			data-endspeed="300"
			style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><div style="text-align:left;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
                <br />do eiusmod tempor incididunt ut labore</div>
		</div>
	...
	<li data-transition="fade" data-slotamount="7" data-masterspeed="500"  data-saveperformance="on"  data-title="Intro Slide">
		...
		<div class="tp-caption title-bold tp-resizeme rs-parallaxlevel-0 fade start"
			...
			data-endelementdelay="0.1"
			data-endspeed="300"
			style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">Depilación Láser
		</div>
        ...
        <div class="tp-caption small-title tp-resizeme rs-parallaxlevel-0 fade start"
			...
			data-endelementdelay="0.1"
			data-endspeed="300"
			style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">Cuida y mejora
            tu piel
		</div>
    ...
    <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"
                        ...
                        <img src="{{ asset('assets/images/slides/banner-img10.jpg') }}" alt="" data-bgposition="center top" data-bgfit="cover"
                        ...
                        <div class="tp-caption banner-button tp-resizeme rs-parallaxlevel-0  fade start" data-x="670"
                            ...
                            <div style="text-align:left; background:#525866; border-radius: 5px;">
                                <a href="micro.html" class="read-more"
                                    style=" line-height: initial; color: #fff; text-transform: uppercase; font-weight: 500; padding: 12px 36px; display: inline-block; font-size: 18px; ">Leer
                                    mas</a>
                            </div>
                        </div>
