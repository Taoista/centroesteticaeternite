...
<div align="center" style="line-height:10px"><img alt="" src="{{ asset('assets/images/logo_.png') }}" style="display: block; height: auto; border: 0; width: 268px; max-width: 100%;" title="Yourlogo Light" width="268"/></div>
</td>
</tr>
</table>
</td>
...
<div align="center" style="line-height:10px"><img alt="" src="{{ asset('assets/images/check-icon.png') }}" style="display: block; height: auto; border: 0; width: 93px; max-width: 100%;" title="Check Icon" width="93"/></div>
</td>
</tr>
</table>
...
<p style="margin: 0; font-size: 14px; text-align: center;"><span style="font-size:42px;">Contacto</span></p>
</div>
</div>
</td>
</tr>
...
<div align="center" style="line-height:10px"><img src="{{ asset('assets/images/logo_.png') }}" style="display: block; height: auto; border: 0; width: 204px; max-width: 100%;" title="Yourlogo Light" width="204"/></div>
</td>
</tr>
</table>
...
<td>
<div style="font-family: sans-serif">
<div style="font-size: 14px; mso-line-height-alt: 21px; color: #f9f9f9; line-height: 1.5; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
<p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;"><span style="font-size:12px;">{{ $direccion }}</span></p>
<p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;"><span style="font-size:12px;">{{ $email_contacto }}</span></p>
<p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;"><span style="font-size:12px;">{{ $tel_contacto }}</span></p>
</div>
</div>
</td>
</tr>
